...
\subsection{Partial Derivative with Respect to $b_0$}
...
\subsection{Partial Derivative with Respect to $b_1$}
...
\subsection{Solving for $\widehat{\beta}_1$}
...
\section{Interpreting $\widehat{\beta}_0$ and $\widehat{\beta}_1$}
...
\hline
\textbf{Chapter 5 use} & \textbf{Math Foundations connection} & \textbf{MF textbook location} \\
\hline
...
This chapter's Math Foundations support is still active in the Core Reader, but the full Math Foundations textbook-location map is kept in the full reference build.  The most important connections here are vectors in \(\mathbb{R}^n\), dot products and norms, orthogonality, and matrix-vector multiplication.
}
