...
\end{equation}
Large Cook's distance suggests that deleting observation \(i\) would noticeably change the fitted model.  The most concerning observations usually have both high leverage and a large adjusted residual.
