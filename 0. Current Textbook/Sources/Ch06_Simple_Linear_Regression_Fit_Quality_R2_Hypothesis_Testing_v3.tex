...
\chapter{Simple Linear Regression: Fit Quality, \texorpdfstring{$R^2$}{R-squared}, and Hypothesis Testing}
...
\section{\texorpdfstring{$R^2$}{R-squared}: Proportion of Variation Explained}
...
\section{Interpreting \texorpdfstring{$R^2$}{R-squared}}
...
\CoreCompress{
\section{\texorpdfstring{$R^2$}{R-squared} and Correlation in Simple Linear Regression}
...
\section{Limitations of \texorpdfstring{$R^2$}{R-squared}}
...
\subsection{\texorpdfstring{$R^2$}{R-squared} Does Not Measure Statistical Evidence}
...
\subsection{\texorpdfstring{$R^2$}{R-squared} Does Not Check Model Assumptions}
...
\section{The \texorpdfstring{$F$}{F}-Statistic}
...
\section{The \texorpdfstring{$F$}{F}-Statistic in Terms of \texorpdfstring{$R^2$}{R-squared}}
...
\section{The \texorpdfstring{$F$}{F}-Distribution and the p-Value}
...
\section{The Slope \texorpdfstring{$t$}{t}-Test}
...
\CoreCompress{
\section{Why the SLR \texorpdfstring{$F$}{F}-Test and Slope \texorpdfstring{$t$}{t}-Test Agree}
...
\begin{itemize}
  ...
  \item \textbf{two-sided p-value:} the p-value for $H_0:\beta_1=0$;
...
You should be able to compute TSS, RSS, \(R^2\), and the SLR $F$-statistic; explain the difference between fit and statistical evidence; and read the slope row and model $F$-test from software output.  The full reference text contains the reusable study template; the consolidated Math Foundations source map appears in Appendix~\ref{app:math-foundations-source-map}.
}
