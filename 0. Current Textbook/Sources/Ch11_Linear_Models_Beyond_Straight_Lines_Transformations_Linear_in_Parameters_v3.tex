...
\paragraph{Multicollinearity cross-reference.}
Even when the transformed design is full rank, engineered columns such as indicators, powers, interactions, and transformed variables can be nearly collinear.  When coefficient interpretation or inference matters, check both rank/identifiability and the multicollinearity diagnostics in Chapter~\ref{chap:residual-analysis-model-repair}.
}{
\section{Numerical Stability and Identifiability}
