...
The first question is about predictive signal.  The second question is about collinearity, an early warning sign for the multicollinearity diagnostics developed later.  A predictor can look useful by itself but become less useful once another correlated predictor is included in the model.
