...
\begin{center}
\begin{tabular}{@{}p{0.30\textwidth}p{0.22\textwidth}p{0.32\textwidth}@{}}
\hline
...
\hline
\textbf{Chapter 4 use} & \textbf{Math Foundations connection} & \textbf{MF textbook location} \\
\hline
...
The Core Reader keeps the short Math Foundations connections for vector summaries, centered vectors, norms, and correlation as a normalized dot product.  The full Math Foundations textbook-location map for this chapter appears in the full reference textbook.
